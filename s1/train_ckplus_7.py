...
parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="use ga generated population for evaluation",
)
...
args.save = "eval-{}-{}".format(args.save, 1)
...
logging.info(
    "[INFO] torch version: {}, torchvision version: {}".format(
...
def main():
    ...
    logging.info(
        "[INFO] len(train_data): {}, len(valid_data): {}".format(
    ...
    for epoch in range(args.epochs):
        ...
        logging.info(
            "[INFO] train_acc %f finished in %f minutes",
            train_acc,
...
def train(train_queue, model, criterion, optimizer):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        if step % args.report_freq == 0:
            ...
            logging.info(
                f"train {step:03d} {objs.avg:.5e} {top1.avg:.4f} {top5.avg:.4f}"
            )
